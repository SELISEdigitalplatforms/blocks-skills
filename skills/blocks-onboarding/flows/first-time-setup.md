...
Send the user to **https://cloud.seliseblocks.com** and tell them to create an account (a free tier exists; email verification is part of signup). What to tell them:
...
Projects are created in the portal, not via API. Tell the user, in **https://cloud.seliseblocks.com**:
